...
def get_container_stats() -> DockerStatsModel:
    ...
    for container in containers:
        ...
        container_stat: DockerContainerStatsModel = DockerContainerStatsModel(
            ...
            network_dropped=stats_raw["networks"]["eth0"]["rx_dropped"]
            + stats_raw["networks"]["eth0"]["tx_dropped"],
            block_in=block_in,
            block_out=block_out,
        ...
        system_cpu_usage = max(
            system_cpu_usage, stats_raw["cpu_stats"]["system_cpu_usage"]
        )
